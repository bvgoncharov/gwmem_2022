...
axs[0,0].set_title('Poincar$\mathrm{\\acute{e}}$',fontdict=font)
axs[0,1].set_title('Original BMS',fontdict=font)
axs[0,2].set_title('Extended BMS',fontdict=font)
...
#plt.tight_layout()
#plt.savefig('/home/bgonchar/out_gwmem_2022/publ_fig/lisa_prl.pdf')
plt.savefig('/fred/oz031/mem/gwmem_2022_container/image_content/out_gwmem_2022/publ_fig/lisa_prl.pdf')
plt.close()
