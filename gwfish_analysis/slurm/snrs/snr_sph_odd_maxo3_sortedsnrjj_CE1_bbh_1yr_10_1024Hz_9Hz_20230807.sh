#!/bin/bash
#SBATCH --job-name=snrs_maxo3_ce1_20230807
#SBATCH --output=/fred/oz031/mem/gwmem_2022_container/image_content/logs_gwmem_2022/snrs_maxo3_ce1_10_1024Hz_9_20230807_%A_%a.out
#SBATCH --ntasks=1
#SBATCH --time=0-1
