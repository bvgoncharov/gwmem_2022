#!/bin/bash
#SBATCH --job-name=m00_maxo3_3_20230514
#SBATCH --output=/fred/oz031/mem/gwmem_2022_container/image_content/logs_gwmem_2022/m00_maxo3_3yr_ET_10_1024Hz_9_20230514_%A_%a.out
#SBATCH --ntasks=1
#SBATCH --time=0-4
