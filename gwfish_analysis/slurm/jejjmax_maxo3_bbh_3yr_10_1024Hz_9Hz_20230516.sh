#!/bin/bash
#SBATCH --job-name=jejj_maxo3_3_20230516
#SBATCH --output=/fred/oz031/mem/gwmem_2022_container/image_content/logs_gwmem_2022/jejj_maxo3_3yr_10_1024Hz_9_20230516_%A_%a.out
#SBATCH --ntasks=1
#SBATCH --time=0-17
