#!/bin/bash
#SBATCH --job-name=m_mino3_20230530
#SBATCH --output=/fred/oz031/mem/gwmem_2022_container/image_content/logs_gwmem_2022/m_mino3_ET_10_1024Hz_9_20230530_%A_%a.out
#SBATCH --ntasks=1
#SBATCH --time=0-15
