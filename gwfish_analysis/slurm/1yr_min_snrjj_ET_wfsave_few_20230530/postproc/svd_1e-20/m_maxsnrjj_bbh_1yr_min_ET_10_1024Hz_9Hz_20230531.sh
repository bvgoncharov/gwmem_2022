#!/bin/bash
#SBATCH --job-name=m_maxo3_n_20230531
#SBATCH --output=/fred/oz031/mem/gwmem_2022_container/image_content/logs_gwmem_2022/m_maxo3_ET_10_1024Hz_9_noise_20230531_%A_%a.out
#SBATCH --ntasks=1
#SBATCH --time=0-6
