#!/bin/bash
#SBATCH --job-name=mje_li_2.5gp_20230515
#SBATCH --output=/fred/oz031/mem/gwmem_2022_container/image_content/logs_gwmem_2022/mje_LISA_flexHz_2.5Gpc_20230515_%A_%a.out
#SBATCH --ntasks=1
#SBATCH --time=0-13
