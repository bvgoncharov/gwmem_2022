#!/bin/bash
#SBATCH --job-name=mje_gwt_11_20230502
#SBATCH --output=/fred/oz031/mem/gwmem_2022_container/image_content/logs_gwmem_2022/mje_gwtclike_ET_10_1024Hz_11_20230502_%A_%a.out
#SBATCH --ntasks=1
#SBATCH --time=0-23
