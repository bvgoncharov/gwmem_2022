#!/bin/bash
#SBATCH --job-name=mje_maxo3_20230505
#SBATCH --output=/fred/oz031/mem/gwmem_2022_container/image_content/logs_gwmem_2022/mje_maxo3_ET_10_1024Hz_9_20230505_%A_%a.out
#SBATCH --ntasks=1
#SBATCH --time=0-4
