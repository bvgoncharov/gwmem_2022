#!/bin/bash
#SBATCH --job-name=jejj_mino3_20230529
#SBATCH --output=/fred/oz031/mem/gwmem_2022_container/image_content/logs_gwmem_2022/jejj_mino3_10_1024Hz_9_20230529_%A_%a.out
#SBATCH --ntasks=1
#SBATCH --time=0-17
